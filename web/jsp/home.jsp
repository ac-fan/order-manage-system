                            ...
                            <div class="col-lg-6 col-xxl-4">
                                ...
                                <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                                    <div class="card-header border-0 bg-danger py-5">
                                        <h3 class="card-title font-weight-bolder text-white">快捷面板</h3>
                                    </div>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M5.5,13 L9.5,13 C10.3284271,13 11,13.6715729 11,14.5 L11,18.5 C11,19.3284271 10.3284271,20 9.5,20 L5.5,20 C4.67157288,20 4,19.3284271 4,18.5 L4,14.5 C4,13.6715729 4.67157288,13 5.5,13 Z M14.5,4 L18.5,4 C19.3284271,4 20,4.67157288 20,5.5 L20,9.5 C20,10.3284271 19.3284271,11 18.5,11 L14.5,11 C13.6715729,11 13,10.3284271 13,9.5 L13,5.5 C13,4.67157288 13.6715729,4 14.5,4 Z M14.5,13 L18.5,13 C19.3284271,13 20,13.6715729 20,14.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,19.3284271 13,18.5 L13,14.5 C13,13.6715729 13.6715729,13 14.5,13 Z"
              fill="#000000" opacity="0.3"/>
                                                ...
                                                <a class="text-inverse-success font-weight-bold font-size-lg mt-1"></a>
                                            </div>
                                        </div>
                                        <!--end::Tiles Widget 11-->
                                    </div>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="card card-custom card-stretch gutter-b">
                                            <div class="card-body d-flex p-0 card-rounded">
                                                <div class="flex-grow-1 p-10 bg-danger card-rounded flex-grow-1 bgi-no-repeat"
                                                     style="background-color: #663259; background-position: calc(100% + 0.5rem) bottom; background-size: auto 75%; background-image: url(/static/images/home-images1.svg)">

                                                    <h4 class="text-inverse-danger mt-2 font-weight-bolder">Based
                                                        On</h4>

                                                    <div class="mt-5">
                                                        <div class="d-flex mb-5">
                <span class="svg-icon svg-icon-md svg-icon-white flex-shrink-0 mr-3"><!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg--><svg
...
</svg><!--end::Svg Icon--></span> <span class="text-white">标准化</span>
                                                        </div>
...
</svg><!--end::Svg Icon--></span> <span class="text-white">快捷化</span>
                                                        </div>
...
</svg><!--end::Svg Icon--></span> <span class="text-white">一体化</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
